    ...
    try {
      const res = await fetch("/api/email", {
        body: JSON.stringify({
          ...
          message: `${inputEl.current.value} : wants to communicate, Please initiate the communication.`,
        }),
        headers: {
      ...
      console.log("In the try", error)
      handleMailChimpResponse(
        error,
        "Success! 🎉 You are now subscribed to the newsletter."
      );
    } catch (ex) {
      console.log("in the catch",ex)
      handleMailChimpResponse("Oops!!! Could not subscribe.");
    }
  };
        ...
        <Box sx={styles.contentBox}>
          <Box sx={styles.contentBoxInner}>
            ...
            <Text as="p" sx={styles.description}>
              Get all our upcoming service and product by subscribing down
              below.
            </Text>
